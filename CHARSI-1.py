...
\033[94;1m===================================>\x1b[92;1m
\033[91;1m AUTHUR       \033[93;1m=>         \x1b[93;1mSHANI
\033[91;1m WHATSP       \x1b[92;1m=>        \x1b[93;1m+84588349979
\033[91;1m GITHUB       \x1b[92;1m=>         \x1b[93;1mCHARSI_GANG👻
\033[91;1m FB GROUP      \x1b[92;1m=>        \x1b[93;1mCRACKING WORLD 🌎
\033[94;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #SHANI
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/profile.php?id=100062257835879")
		exit()
	else:
		os.system("https://www.facebook.com/profile.php?id=100062257835879")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [SHANI] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [L LAG GAIY-CP] %s|%s        '%(b,idf,pw))
